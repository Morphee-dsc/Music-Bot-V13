...
module.exports = async (bot) => {
    ...
    bot.player.events.on('audioTrackAdd', (queue, track) => {
        queue.metadata.channel.send({ embeds: [Embed.setDescription(`✅ | La musique **${track.title}** as bien été ajouté à la file d'attente ! Veuillez attendre que le bot trouve la musique pour l'écouté !`)] });
    });
